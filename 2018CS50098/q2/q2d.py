...
ax.set_title('Movement of θ')
ax.set_xlabel('θ0')
ax.set_ylabel('θ1')
ax.set_zlabel('θ2')
ax.plot3D(thetha_0,thetha_1,thetha_2)
for i in range(len(J_thetha)):
    ax.scatter(thetha_0[i], thetha_1[i], thetha_2[i])
    # plt.pause(0.0002)
plt.savefig(sys.argv[2]+'/q2d1.png')
# part4 ends here
...
for i in range(len(J_thetha)):
    ax.scatter(thetha_0[i], thetha_1[i], thetha_2[i])
    # plt.pause(0.0002)
plt.savefig(sys.argv[2]+'/q2d2.png')
# part4 ends here
...
for i in range(len(J_thetha)):
    ax.scatter(thetha_0[i], thetha_1[i], thetha_2[i])
    # plt.pause(0.0002)
plt.savefig(sys.argv[2]+'/q2d3.png')
# part4 ends here
...
for i in range(len(J_thetha)):
    ax.scatter(thetha_0[i], thetha_1[i], thetha_2[i])
    # plt.pause(0.2)
plt.savefig(sys.argv[2]+'/q2d4.png')
# part4 ends here
